...
describe "Javascript grammar", ->
  ...
  it "doesn't confuse strings and functions", ->
    ...
    {tokens} = grammar.tokenizeLine('a.push("x" + y + ":function()");')
    expect(tokens[2]).toEqual value: 'push', scopes: ['source.js', 'support.function.js']
    expect(tokens[3]).toEqual value: '(', scopes: ['source.js', 'meta.brace.round.js']
    expect(tokens[4]).toEqual value: '"', scopes: ['source.js', 'string.quoted.double.js', 'punctuation.definition.string.begin.js']
    expect(tokens[5]).toEqual value: 'x', scopes: ['source.js', 'string.quoted.double.js']
    expect(tokens[6]).toEqual value: '"', scopes: ['source.js', 'string.quoted.double.js', 'punctuation.definition.string.end.js']
    ...
    expect(tokens[12]).toEqual value: '"', scopes: ['source.js', 'string.quoted.double.js', 'punctuation.definition.string.begin.js']
    expect(tokens[13]).toEqual value: ':function()', scopes: ['source.js', 'string.quoted.double.js']
    expect(tokens[14]).toEqual value: '"', scopes: ['source.js', 'string.quoted.double.js', 'punctuation.definition.string.end.js']

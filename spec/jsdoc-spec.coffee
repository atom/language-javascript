describe "JSDoc grammar", ->
  ...
  describe "block tags", ->
    ...
    describe "default @param values", ->
      ...
      it "tokenises arrays inside object literals", ->
        ...
        expect(tokens[35]).toEqual value: '}', scopes: ['source.js', 'comment.block.documentation.js', 'variable.other.jsdoc', 'source.embedded.js']
  ...
  describe "when the containing comment ends unexpectedly", ->
    ...
    it "terminates any embedded JavaScript code", ->
      ...
      expect(tokens[24]).toEqual value: '}', scopes: ['source.js', 'comment.block.documentation.js', 'variable.other.jsdoc', 'source.embedded.js']
      expect(tokens[25]).toEqual value: ']', scopes: ['source.js', 'comment.block.documentation.js', 'variable.other.jsdoc', 'source.embedded.js', 'meta.brace.square.js']
